...
#define INST_NAME psubsb
#define INTRINSIC_FUN _mm_subs_epi8
#define SRC1 {-128, -5, -3, -7, 50, 100, 15 ,127, -128, -5, -3, -7, 50, -10, 15 ,127};
#define SRC2 {-10, 15, 17, -23, -1, 0, -128, -128, -10, 15, 17, -23, -1, 127, -20, -50};
#define CON  {-118, -20, -20, 16, 51, 100, 127, 127, -118, -20, -20, 16, 51, -128, 35, 127};
