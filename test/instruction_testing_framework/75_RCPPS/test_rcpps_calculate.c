...
#define SRC1 {1.0f, 1.0f, 1.0f, 1.0f}
#define SRC2 {55.6f, 43.4f, 0.456f, 2.34f}
#define CON {0.017986297607421875f, 0.023040771484375f, 2.19287109375f, 0.42730712890625f}
