...
#define INST_NAME unpcklps
#define INTRINSIC_FUN _mm_unpacklo_ps
#define SRC1 {55.6f, 43.4f, 0.456f, 2.34f};
#define SRC2 {65.3f, 73.6f, -12.4f, -2.0f};
#define CON {55.599998474121094f, 65.300003051757812f, 43.400001525878906f, 73.599998474121094f}
