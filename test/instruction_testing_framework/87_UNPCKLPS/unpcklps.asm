...
test_unpcklps_static_musl:     Dateiformat elf64-x86-64
...
int main() {
  ...
  4023f1:	f3 0f 10 05 6b 5d 00 	movss  0x5d6b(%rip),%xmm0        # 408164 <_fini+0x1160>
  4023f8:	00 
  4023f9:	f3 0f 11 85 d0 fa ff 	movss  %xmm0,-0x530(%rbp)
  402400:	ff 
  402401:	f3 0f 10 05 6b 5d 00 	movss  0x5d6b(%rip),%xmm0        # 408174 <_fini+0x1170>
  402408:	00 
  402409:	f3 0f 11 85 d4 fa ff 	movss  %xmm0,-0x52c(%rbp)
  402410:	ff 
  402411:	f3 0f 10 05 4f 5d 00 	movss  0x5d4f(%rip),%xmm0        # 408168 <_fini+0x1164>
  402418:	00 
  402419:	f3 0f 11 85 d8 fa ff 	movss  %xmm0,-0x528(%rbp)
  402420:	ff 
  402421:	f3 0f 10 05 4f 5d 00 	movss  0x5d4f(%rip),%xmm0        # 408178 <_fini+0x1174>
  402428:	00 
  ...
  402471:	0f 14 c1             	unpcklps %xmm1,%xmm0
  402474:	9c                   	pushf
  402475:	58                   	pop    %rax
  402476:	0f 29 85 90 fa ff ff 	movaps %xmm0,-0x570(%rbp)
  40247d:	48 89 85 88 fa ff ff 	mov    %rax,-0x578(%rbp)
#endif
...
#else
    EXTRACT(out, v1);
  402484:	0f 28 85 90 fa ff ff 	movaps -0x570(%rbp),%xmm0
  40248b:	48 8d 85 e0 fa ff ff 	lea    -0x520(%rbp),%rax
  402492:	48 89 c7             	mov    %rax,%rdi
  402495:	e8 bc f1 ff ff       	call   401656 <extract_f32>
#endif

    char in1_s[255];
    TO_STRING_IN(in1_s, in1);
  40249a:	48 8d 95 b0 fa ff ff 	lea    -0x550(%rbp),%rdx
  4024a1:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  4024a8:	48 89 d6             	mov    %rdx,%rsi
  4024ab:	48 89 c7             	mov    %rax,%rdi
  4024ae:	e8 c7 f2 ff ff       	call   40177a <to_string_f32>
#ifdef SRC2
    char in2_s[255];
    TO_STRING_IN(in2_s, in2);
  4024b3:	48 8d 95 c0 fa ff ff 	lea    -0x540(%rbp),%rdx
  4024ba:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  4024c1:	48 89 d6             	mov    %rdx,%rsi
  4024c4:	48 89 c7             	mov    %rax,%rdi
  4024c7:	e8 ae f2 ff ff       	call   40177a <to_string_f32>
#endif
#ifdef SRC3
    char in3_s[255];
  4024cc:	48 8d 95 e0 fa ff ff 	lea    -0x520(%rbp),%rdx
  4024d3:	48 8d 85 f0 fc ff ff 	lea    -0x310(%rbp),%rax
  4024da:	48 89 d6             	mov    %rdx,%rsi
  4024dd:	48 89 c7             	mov    %rax,%rdi
  4024e0:	e8 95 f2 ff ff       	call   40177a <to_string_f32>
    TO_STRING_IN(in3_s, in3);
#endif
  4024e5:	48 8d 95 d0 fa ff ff 	lea    -0x530(%rbp),%rdx
  4024ec:	48 8d 85 f0 fd ff ff 	lea    -0x210(%rbp),%rax
  4024f3:	48 89 d6             	mov    %rdx,%rsi
  4024f6:	48 89 c7             	mov    %rax,%rdi
  4024f9:	e8 7c f2 ff ff       	call   40177a <to_string_f32>
#ifdef IMM8
    char imm8_s[255];
  ...
  4024fe:	48 8b 95 88 fa ff ff 	mov    -0x578(%rbp),%rdx
  402505:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  40250c:	48 89 d6             	mov    %rdx,%rsi
  40250f:	48 89 c7             	mov    %rax,%rdi
  402512:	e8 5d fc ff ff       	call   402174 <flags_to_string>
...
#ifdef PRINT
#ifdef SRC3
  402517:	4c 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%r8
  40251e:	48 8d b5 f0 fd ff ff 	lea    -0x210(%rbp),%rsi
  402525:	48 8d 8d f0 fc ff ff 	lea    -0x310(%rbp),%rcx
  40252c:	48 8d 95 f0 fb ff ff 	lea    -0x410(%rbp),%rdx
  402533:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  40253a:	48 8d 3d e7 5b 00 00 	lea    0x5be7(%rip),%rdi        # 408128 <_fini+0x1124>
  402541:	4d 89 c1             	mov    %r8,%r9
  402544:	49 89 f0             	mov    %rsi,%r8
  402547:	48 89 c6             	mov    %rax,%rsi
  40254a:	b8 00 00 00 00       	mov    $0x0,%eax
  40254f:	e8 2c 04 00 00       	call   402980 <printf>
#else
#ifdef IMM8
  ...
  402559:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  40255d:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
  402564:	00 00 
  402566:	74 05                	je     40256d <main+0x21a>
  402568:	e8 b3 03 00 00       	call   402920 <__stack_chk_fail>
  40256d:	c9                   	leave
  40256e:	c3                   	ret
  40256f:	90                   	nop
