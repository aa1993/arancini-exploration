...
#define INST_NAME movsldup
#define INTRINSIC_FUN _mm_moveldup_ps
#define SRC1 {55.6f, 43.4f, 0.456f, 2.34f}
#define CON {55.599998474121094f, 55.599998474121094f, 0.45600000023841858f, 0.45600000023841858f}
