...
#define INST_NAME insertps
#define INTRINSIC_FUN _mm_insert_ps
#define SRC1 {55.6f, 43.4f, 0.456f, 2.34f};
#define SRC2 {65.3f, 73.6f, -12.4f, -2.0f};
#define IMM8 0b01110001
#define CON {0.0f, 43.400001525878906f, 0.45600000023841858f, 73.599998474121094f}
