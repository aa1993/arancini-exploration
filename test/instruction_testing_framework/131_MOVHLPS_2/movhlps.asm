...
int main() {
  ...
  40217c:	48 81 ec 80 04 00 00 	sub    $0x480,%rsp
  ...
  4021e2:	c7 85 d0 fb ff ff 34 	movl   $0xc286c534,-0x430(%rbp)
  4021e9:	c5 86 c2 
  4021ec:	c7 85 d4 fb ff ff 24 	movl   $0x630d6b24,-0x42c(%rbp)
  4021f3:	6b 0d 63 
  4021f6:	c7 85 d8 fb ff ff b9 	movl   $0x8a2ca0b9,-0x428(%rbp)
  4021fd:	a0 2c 8a 
  402200:	c7 85 dc fb ff ff 84 	movl   $0xf7194d84,-0x424(%rbp)
  402207:	4d 19 f7 
  ...
  402211:	48 8d 85 80 fb ff ff 	lea    -0x480(%rbp),%rax
  ...
  40222a:	48 8d 85 90 fb ff ff 	lea    -0x470(%rbp),%rax
  402231:	48 89 d6             	mov    %rdx,%rsi
  402234:	48 89 c7             	mov    %rax,%rdi
  402237:	e8 68 f3 ff ff       	call   4015a4 <insert_i32>

    asm volatile (
  40223c:	66 0f 6f 8d 90 fb ff 	movdqa -0x470(%rbp),%xmm1
  402243:	ff 
  402244:	66 0f 6f 85 80 fb ff 	movdqa -0x480(%rbp),%xmm0
  40224b:	ff 
  40224c:	0f 12 c8             	movhlps %xmm0,%xmm1
  40224f:	0f 29 85 80 fb ff ff 	movaps %xmm0,-0x480(%rbp)
        "movhlps %[v1], %[v2]"
        : [v1] "+x"(v1)        // output
        : [v2] "x"(v2)      // input
    );
//    SSE_TYPE res = (__m128i)INTRINSIC_FUN((__m128)v1,(__m128) v2);
    SSE_TYPE res = v1;
  402256:	66 0f 6f 85 80 fb ff 	movdqa -0x480(%rbp),%xmm0
  40225d:	ff 
  40225e:	0f 29 85 a0 fb ff ff 	movaps %xmm0,-0x460(%rbp)

    EXTRACT(out, res);
  402265:	66 0f 6f 85 a0 fb ff 	movdqa -0x460(%rbp),%xmm0
  40226c:	ff 
  40226d:	48 8d 85 e0 fb ff ff 	lea    -0x420(%rbp),%rax
  402274:	48 89 c7             	mov    %rax,%rdi
  402277:	e8 9c f4 ff ff       	call   401718 <extract_i32>

    char in1_s[255];
    TO_STRING_IN(in1_s, in1);
  40227c:	48 8d 95 b0 fb ff ff 	lea    -0x450(%rbp),%rdx
  402283:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  40228a:	48 89 d6             	mov    %rdx,%rsi
  40228d:	48 89 c7             	mov    %rax,%rdi
  402290:	e8 65 f9 ff ff       	call   401bfa <to_string_i32>
    char in2_s[255];
    TO_STRING_IN(in2_s, in2);
  402295:	48 8d 95 c0 fb ff ff 	lea    -0x440(%rbp),%rdx
  40229c:	48 8d 85 f0 fc ff ff 	lea    -0x310(%rbp),%rax
  4022a3:	48 89 d6             	mov    %rdx,%rsi
  4022a6:	48 89 c7             	mov    %rax,%rdi
  4022a9:	e8 4c f9 ff ff       	call   401bfa <to_string_i32>
    char out_s[255];
    TO_STRING_OUT(out_s, out);
  4022ae:	48 8d 95 e0 fb ff ff 	lea    -0x420(%rbp),%rdx
  4022b5:	48 8d 85 f0 fd ff ff 	lea    -0x210(%rbp),%rax
  4022bc:	48 89 d6             	mov    %rdx,%rsi
  4022bf:	48 89 c7             	mov    %rax,%rdi
  4022c2:	e8 33 f9 ff ff       	call   401bfa <to_string_i32>
    char con_s[255];
    TO_STRING_OUT(con_s, con);
  4022c7:	48 8d 95 d0 fb ff ff 	lea    -0x430(%rbp),%rdx
  4022ce:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  4022d5:	48 89 d6             	mov    %rdx,%rsi
  4022d8:	48 89 c7             	mov    %rax,%rdi
  4022db:	e8 1a f9 ff ff       	call   401bfa <to_string_i32>
  ...
  4022e0:	48 8d b5 f0 fe ff ff 	lea    -0x110(%rbp),%rsi
  4022e7:	48 8d 8d f0 fd ff ff 	lea    -0x210(%rbp),%rcx
  4022ee:	48 8d 95 f0 fc ff ff 	lea    -0x310(%rbp),%rdx
  4022f5:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  4022fc:	48 8d 3d d5 4d 00 00 	lea    0x4dd5(%rip),%rdi        # 4070d8 <_fini+0x314>
  402303:	49 89 f0             	mov    %rsi,%r8
  402306:	48 89 c6             	mov    %rax,%rsi
  402309:	b8 00 00 00 00       	mov    $0x0,%eax
  40230e:	e8 2d 04 00 00       	call   402740 <printf>
        }
    }
    ...
    return 0;
  402313:	b8 00 00 00 00       	mov    $0x0,%eax
}
  402318:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  40231c:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
  402323:	00 00 
  402325:	74 05                	je     40232c <main+0x1b8>
  402327:	e8 b4 03 00 00       	call   4026e0 <__stack_chk_fail>
  40232c:	c9                   	leave
  40232d:	c3                   	ret
  40232e:	66 90                	xchg   %ax,%ax

0000000000402330 <dummy>:
...
0000000000402360 <__init_libc>:
  ...
  4024ef:	48 8d 3d 02 4c 00 00 	lea    0x4c02(%rip),%rdi        # 4070f8 <_fini+0x334>
  ...
  402587:	48 8d 3d a9 4b 00 00 	lea    0x4ba9(%rip),%rdi        # 407137 <_fini+0x373>
...
00000000004028d0 <pop_arg>:
  ...
  4028d8:	48 8d 0d 59 48 00 00 	lea    0x4859(%rip),%rcx        # 407138 <_fini+0x374>
...
0000000000402bc0 <fmt_fp>:
  ...
  402c30:	48 8d 05 cb 44 00 00 	lea    0x44cb(%rip),%rax        # 407102 <_fini+0x33e>
  ...
  402cca:	48 8d 05 34 44 00 00 	lea    0x4434(%rip),%rax        # 407105 <_fini+0x341>
  ...
  402d0b:	d8 0d 73 47 00 00    	fmuls  0x4773(%rip)        # 407484 <states+0x1e4>
  ...
  402d29:	d9 05 59 47 00 00    	flds   0x4759(%rip)        # 407488 <states+0x1e8>
  ...
  4030e5:	d9 05 89 43 00 00    	flds   0x4389(%rip)        # 407474 <states+0x1d4>
  4030eb:	d9 05 87 43 00 00    	flds   0x4387(%rip)        # 407478 <states+0x1d8>
  4030f1:	e9 1d 05 00 00       	jmp    403613 <fmt_fp+0xa53>
  4030f6:	48 8d 1d 06 40 00 00 	lea    0x4006(%rip),%rbx        # 407103 <_fini+0x33f>
  ...
  403130:	4c 8d 25 e2 3f 00 00 	lea    0x3fe2(%rip),%r12        # 407119 <_fini+0x355>
  403137:	48 8d 05 e3 3f 00 00 	lea    0x3fe3(%rip),%rax        # 407121 <_fini+0x35d>
  ...
  4031c4:	4c 8d 25 52 3f 00 00 	lea    0x3f52(%rip),%r12        # 40711d <_fini+0x359>
  4031cb:	48 8d 05 43 3f 00 00 	lea    0x3f43(%rip),%rax        # 407115 <_fini+0x351>
  ...
  40330b:	d9 05 6f 41 00 00    	flds   0x416f(%rip)        # 407480 <states+0x1e0>
  ...
  4033a1:	48 8d 0d d8 3e 00 00 	lea    0x3ed8(%rip),%rcx        # 407280 <xdigits>
  ...
  4035f3:	db 2d a7 3e 00 00    	fldt   0x3ea7(%rip)        # 4074a0 <states+0x200>
  ...
  40360d:	d9 05 69 3e 00 00    	flds   0x3e69(%rip)        # 40747c <states+0x1dc>
  ...
  403994:	66 0f 6f 05 14 3b 00 	movdqa 0x3b14(%rip),%xmm0        # 4074b0 <states+0x210>
  40399b:	00 
  ...
  403ab3:	66 0f 6f 05 f5 39 00 	movdqa 0x39f5(%rip),%xmm0        # 4074b0 <states+0x210>
  403aba:	00 
  ...
  403ae0:	48 8d 3d 3e 36 00 00 	lea    0x363e(%rip),%rdi        # 407125 <_fini+0x361>
  ...
  403b0f:	66 0f 6f 05 99 39 00 	movdqa 0x3999(%rip),%xmm0        # 4074b0 <states+0x210>
  403b16:	00 
  ...
  403e2b:	48 8d 3d f3 32 00 00 	lea    0x32f3(%rip),%rdi        # 407125 <_fini+0x361>
  ...
  403e86:	66 0f 6f 05 22 36 00 	movdqa 0x3622(%rip),%xmm0        # 4074b0 <states+0x210>
  403e8d:	00 
  ...
  403f33:	d9 05 37 35 00 00    	flds   0x3537(%rip)        # 407470 <states+0x1d0>
  403f39:	d9 05 41 35 00 00    	flds   0x3541(%rip)        # 407480 <states+0x1e0>
  ...
  404104:	db 2d 96 33 00 00    	fldt   0x3396(%rip)        # 4074a0 <states+0x200>
  40410a:	d9 05 68 33 00 00    	flds   0x3368(%rip)        # 407478 <states+0x1d8>
  ...
  404139:	d9 05 35 33 00 00    	flds   0x3335(%rip)        # 407474 <states+0x1d4>
  ...
  404423:	66 0f 6f 05 85 30 00 	movdqa 0x3085(%rip),%xmm0        # 4074b0 <states+0x210>
  40442a:	00 
  ...
  4044ee:	48 8d 3d 30 2c 00 00 	lea    0x2c30(%rip),%rdi        # 407125 <_fini+0x361>
...
0000000000404540 <printf_core>:
  ...
  404546:	4c 8d 3d 53 2d 00 00 	lea    0x2d53(%rip),%r15        # 4072a0 <states>
  ...
  4049f6:	48 8d 3d 83 27 00 00 	lea    0x2783(%rip),%rdi        # 407180 <_fini+0x3bc>
  ...
  404cd9:	48 8d 3d 47 24 00 00 	lea    0x2447(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  404e94:	48 8d 3d 8c 22 00 00 	lea    0x228c(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  404fe4:	48 8d 35 95 22 00 00 	lea    0x2295(%rip),%rsi        # 407280 <xdigits>
  ...
  405027:	48 8d 3d f9 20 00 00 	lea    0x20f9(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  405215:	48 8d 3d 0b 1f 00 00 	lea    0x1f0b(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  405263:	48 8d 3d bd 1e 00 00 	lea    0x1ebd(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  405284:	48 8d 05 a6 1e 00 00 	lea    0x1ea6(%rip),%rax        # 407131 <_fini+0x36d>
  ...
  405313:	48 8d 3d 0d 1e 00 00 	lea    0x1e0d(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  40539b:	48 8d 15 be 1e 00 00 	lea    0x1ebe(%rip),%rdx        # 407260 <_fini+0x49c>
  ...
  4053bb:	48 8d 3d 65 1d 00 00 	lea    0x1d65(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  4054b3:	48 8d 3d 6d 1c 00 00 	lea    0x1c6d(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  405626:	48 8d 15 fa 1a 00 00 	lea    0x1afa(%rip),%rdx        # 407127 <_fini+0x363>
  ...
  4056cf:	48 8d 3d 51 1a 00 00 	lea    0x1a51(%rip),%rdi        # 407127 <_fini+0x363>
  ...
  4056eb:	48 8d 3d 36 1a 00 00 	lea    0x1a36(%rip),%rdi        # 407128 <_fini+0x364>
  ...
  40570f:	48 8d 3d 13 1a 00 00 	lea    0x1a13(%rip),%rdi        # 407129 <_fini+0x365>
...
0000000000405ef0 <__strerror_l>:
  ...
  405ef4:	48 8d 05 e5 16 00 00 	lea    0x16e5(%rip),%rax        # 4075e0 <errmsgstr>
  405efb:	81 ff 83 00 00 00    	cmp    $0x83,%edi
  405f01:	77 11                	ja     405f14 <__strerror_l+0x24>
  405f03:	48 63 ff             	movslq %edi,%rdi
  405f06:	48 8d 15 b3 15 00 00 	lea    0x15b3(%rip),%rdx        # 4074c0 <errmsgidx>
...
0000000000406030 <frexpl>:
  ...
  4060a3:	d8 0d e3 13 00 00    	fmuls  0x13e3(%rip)        # 40748c <states+0x1ec>
...
00000000004065d0 <vsnprintf>:
  ...
  40664e:	48 8b 05 0b 17 00 00 	mov    0x170b(%rip),%rax        # 407d60 <errmsgstr+0x780>
...
0000000000406920 <wcrtomb>:
  ...
  4069e3:	8b 35 a7 0a 00 00    	mov    0xaa7(%rip),%esi        # 407490 <states+0x1f0>
