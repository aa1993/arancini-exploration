...
#define SRC2 {1.0f, 1.0f, 1.0f, 1.0f}
#define CON {7.456540584564209, 6.5878677368164062, 0.6752777099609375, 1.5297058820724487}
#define ONE_ARG
...
int main() {
    ...
    SSE_TYPE res = _mm_sqrt_ss(v1);
    res = _mm_div_ss(v2, res);
