...
#define INST_NAME cvtpi2ps
#define INTRINSIC_FUN _mm_cvtpi32_ps
#define SRC1 {0, 0}
#define SRC2 {1048884625, -1470057930}
#define CON  {1048884625.0f, -1470057930.0f, 0.0f, 0.0f}
