...
void extract_f63( double dest[], __m128d input){
...
int main() {
    unsigned short in1[16] = {500, 65535, 65535, 250, 400, 100, 150 ,150};
    unsigned short in2[16] = {65535, 32767, 250, 400, 333, 300, 255, 188};
    ...
    __m128i res = _mm_minpos_epu16(v2);

    extract_i16(out, res);

    char in1_s[255];
    to_string_u16(in1_s, in1);
    char in2_s[255];
    to_string_u16(in2_s, in2);
    char out_s[255];
    to_string_u16(out_s, out);
