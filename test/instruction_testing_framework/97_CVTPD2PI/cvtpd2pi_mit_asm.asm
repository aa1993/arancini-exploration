...
int main() {
  ...
  4023d8:	e8 2e 01 00 00       	call   40250b <m64_insert_i32>
    SSE_TYPE v2;
    INSERT(&v2, in2);
  ...
  4023f1:	e8 ed ed ff ff       	call   4011e3 <insert_f64>
    ...
    asm volatile (
  4023f6:	66 0f 28 85 b0 fa ff 	movapd -0x550(%rbp),%xmm0
  4023fd:	ff 
       STR(INST_NAME)" %[v2], %[v1]\n\t"
       "pushfq\n\t"
       "popq %[flags]"
        : [v1] "+y"(v1.mm),[flags] "=r" (flags)         // output
  4023fe:	48 8b 85 c0 fa ff ff 	mov    -0x540(%rbp),%rax
    asm volatile (
  402405:	48 0f 6e c0          	movq   %rax,%mm0
  402409:	66 0f 2d c0          	cvtpd2pi %xmm0,%mm0
  40240d:	9c                   	pushf
  40240e:	58                   	pop    %rax
  40240f:	0f 7f 85 c0 fa ff ff 	movq   %mm0,-0x540(%rbp)
  402416:	48 89 85 a8 fa ff ff 	mov    %rax,-0x558(%rbp)
        : [v2] "x"(v2)      // input
    );

    m64_extract_i32(out, v1);
  40241d:	48 8b 95 c0 fa ff ff 	mov    -0x540(%rbp),%rdx
  402424:	48 8d 85 d8 fa ff ff 	lea    -0x528(%rbp),%rax
  40242b:	48 89 d6             	mov    %rdx,%rsi
  40242e:	48 89 c7             	mov    %rax,%rdi
  402431:	e8 02 01 00 00       	call   402538 <m64_extract_i32>

    char in1_s[255];
    m64_to_string_i32(in1_s, in1);
  402436:	48 8d 95 c8 fa ff ff 	lea    -0x538(%rbp),%rdx
  40243d:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  402444:	48 89 d6             	mov    %rdx,%rsi
  402447:	48 89 c7             	mov    %rax,%rdi
  40244a:	e8 12 01 00 00       	call   402561 <m64_to_string_i32>
    char in2_s[255];
    TO_STRING_IN(in2_s, in2);
  40244f:	48 8d 95 e0 fa ff ff 	lea    -0x520(%rbp),%rdx
  402456:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  40245d:	48 89 d6             	mov    %rdx,%rsi
  402460:	48 89 c7             	mov    %rax,%rdi
  402463:	e8 f6 f3 ff ff       	call   40185e <to_string_f64>
    char out_s[255];
    m64_to_string_i32(out_s, out);
  402468:	48 8d 95 d8 fa ff ff 	lea    -0x528(%rbp),%rdx
  40246f:	48 8d 85 f0 fc ff ff 	lea    -0x310(%rbp),%rax
  402476:	48 89 d6             	mov    %rdx,%rsi
  402479:	48 89 c7             	mov    %rax,%rdi
  40247c:	e8 e0 00 00 00       	call   402561 <m64_to_string_i32>
    char con_s[255];
    m64_to_string_i32(con_s, con);
  402481:	48 8d 95 d0 fa ff ff 	lea    -0x530(%rbp),%rdx
  402488:	48 8d 85 f0 fd ff ff 	lea    -0x210(%rbp),%rax
  40248f:	48 89 d6             	mov    %rdx,%rsi
  402492:	48 89 c7             	mov    %rax,%rdi
  402495:	e8 c7 00 00 00       	call   402561 <m64_to_string_i32>
    char flags_s[255];
    flags_to_string(flags_s, flags);
  40249a:	48 8b 95 a8 fa ff ff 	mov    -0x558(%rbp),%rdx
  4024a1:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  4024a8:	48 89 d6             	mov    %rdx,%rsi
  4024ab:	48 89 c7             	mov    %rax,%rdi
  4024ae:	e8 c1 fc ff ff       	call   402174 <flags_to_string>

#ifdef PRINT
    printf(STR(INST_NAME)"\nsrc1: %s\nsrc2: %s\n |\n\\/\nres: %s\ncon: %s\nflags: %s\n",
  4024b3:	4c 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%r8
  4024ba:	48 8d b5 f0 fd ff ff 	lea    -0x210(%rbp),%rsi
  4024c1:	48 8d 8d f0 fc ff ff 	lea    -0x310(%rbp),%rcx
  4024c8:	48 8d 95 f0 fb ff ff 	lea    -0x410(%rbp),%rdx
  4024cf:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  4024d6:	48 8d 3d 4b 5c 00 00 	lea    0x5c4b(%rip),%rdi        # 408128 <_fini+0x10a4>
  4024dd:	4d 89 c1             	mov    %r8,%r9
  4024e0:	49 89 f0             	mov    %rsi,%r8
  4024e3:	48 89 c6             	mov    %rax,%rsi
  4024e6:	b8 00 00 00 00       	mov    $0x0,%eax
  4024eb:	e8 10 05 00 00       	call   402a00 <printf>
        }
    }
  ...
  4024f5:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  4024f9:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
  402500:	00 00 
  402502:	74 05                	je     402509 <main+0x1b6>
  402504:	e8 97 04 00 00       	call   4029a0 <__stack_chk_fail>
  402509:	c9                   	leave
  40250a:	c3                   	ret

000000000040250b <m64_insert_i32>:

void m64_insert_i32( __m64i32* dest, int input[]){
  40250b:	f3 0f 1e fa          	endbr64
  40250f:	55                   	push   %rbp
  402510:	48 89 e5             	mov    %rsp,%rbp
  402513:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  402517:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    (*dest).i32[0] = input[0];
  40251b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  40251f:	8b 10                	mov    (%rax),%edx
  402521:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  402525:	89 10                	mov    %edx,(%rax)
    (*dest).i32[1] = input[1];
  402527:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  40252b:	8b 50 04             	mov    0x4(%rax),%edx
  40252e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  402532:	89 50 04             	mov    %edx,0x4(%rax)
}
  402535:	90                   	nop
  402536:	5d                   	pop    %rbp
  402537:	c3                   	ret

0000000000402538 <m64_extract_i32>:
void m64_extract_i32( int dest[], __m64i32 input){
  402538:	f3 0f 1e fa          	endbr64
  40253c:	55                   	push   %rbp
  40253d:	48 89 e5             	mov    %rsp,%rbp
  402540:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  402544:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    dest[0] = input.i32[0];
  402548:	8b 55 f0             	mov    -0x10(%rbp),%edx
  40254b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40254f:	89 10                	mov    %edx,(%rax)
    dest[1] = input.i32[1];
  402551:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  402555:	48 8d 50 04          	lea    0x4(%rax),%rdx
  402559:	8b 45 f4             	mov    -0xc(%rbp),%eax
  40255c:	89 02                	mov    %eax,(%rdx)
}
  40255e:	90                   	nop
  40255f:	5d                   	pop    %rbp
  402560:	c3                   	ret

0000000000402561 <m64_to_string_i32>:
void m64_to_string_i32(char* dest,  int src[]){
  402561:	f3 0f 1e fa          	endbr64
  402565:	55                   	push   %rbp
  402566:	48 89 e5             	mov    %rsp,%rbp
  402569:	48 81 ec 20 01 00 00 	sub    $0x120,%rsp
  402570:	48 89 bd e8 fe ff ff 	mov    %rdi,-0x118(%rbp)
  402577:	48 89 b5 e0 fe ff ff 	mov    %rsi,-0x120(%rbp)
  40257e:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  402585:	00 00 
  402587:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  40258b:	31 c0                	xor    %eax,%eax
    char res[255];
    sprintf(res, "(%d, %d)",
          src[0], src[1]);
  40258d:	48 8b 85 e0 fe ff ff 	mov    -0x120(%rbp),%rax
  402594:	48 83 c0 04          	add    $0x4,%rax
    sprintf(res, "(%d, %d)",
  402598:	8b 08                	mov    (%rax),%ecx
  40259a:	48 8b 85 e0 fe ff ff 	mov    -0x120(%rbp),%rax
  4025a1:	8b 10                	mov    (%rax),%edx
  4025a3:	48 8d 35 ba 5b 00 00 	lea    0x5bba(%rip),%rsi        # 408164 <_fini+0x10e0>
  4025aa:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  4025b1:	48 89 c7             	mov    %rax,%rdi
  4025b4:	b8 00 00 00 00       	mov    $0x0,%eax
  4025b9:	e8 12 05 00 00       	call   402ad0 <sprintf>
    strcpy(dest, res);
  4025be:	48 8d 95 f0 fe ff ff 	lea    -0x110(%rbp),%rdx
  4025c5:	48 8b 85 e8 fe ff ff 	mov    -0x118(%rbp),%rax
  4025cc:	48 89 d6             	mov    %rdx,%rsi
  4025cf:	48 89 c7             	mov    %rax,%rdi
  4025d2:	e8 09 37 00 00       	call   405ce0 <strcpy>
}
  4025d7:	90                   	nop
  4025d8:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  4025dc:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
  4025e3:	00 00 
  4025e5:	74 05                	je     4025ec <m64_to_string_i32+0x8b>
  4025e7:	e8 b4 03 00 00       	call   4029a0 <__stack_chk_fail>
  4025ec:	c9                   	leave
  4025ed:	c3                   	ret
