...
test_movlhps_static_musl:     Dateiformat elf64-x86-64
...
int main() {
  ...
  402371:	c7 85 b0 fb ff ff df 	movl   $0x197f10df,-0x450(%rbp)
  402378:	10 7f 19 
  40237b:	c7 85 b4 fb ff ff 98 	movl   $0x35d64898,-0x44c(%rbp)
  402382:	48 d6 35 
  402385:	c7 85 b8 fb ff ff b9 	movl   $0x8a2ca0b9,-0x448(%rbp)
  40238c:	a0 2c 8a 
  40238f:	c7 85 bc fb ff ff 84 	movl   $0xf7194d84,-0x444(%rbp)
  402396:	4d 19 f7 
    alignas(SSE_TYPE) C_IN_TYPE in2[IN_LEN] = SRC2;
  402399:	c7 85 c0 fb ff ff 91 	movl   $0x3e84b591,-0x440(%rbp)
  4023a0:	b5 84 3e 
  4023a3:	c7 85 c4 fb ff ff 36 	movl   $0xa860b236,-0x43c(%rbp)
  4023aa:	b2 60 a8 
  4023ad:	c7 85 c8 fb ff ff 34 	movl   $0xc286c534,-0x438(%rbp)
  4023b4:	c5 86 c2 
  4023b7:	c7 85 cc fb ff ff 24 	movl   $0x630d6b24,-0x434(%rbp)
  4023be:	6b 0d 63 
    alignas(SSE_TYPE) C_OUT_TYPE con[OUT_LEN] = CON;
  4023c1:	c7 85 d0 fb ff ff df 	movl   $0x197f10df,-0x430(%rbp)
  4023c8:	10 7f 19 
  4023cb:	c7 85 d4 fb ff ff 98 	movl   $0x35d64898,-0x42c(%rbp)
  4023d2:	48 d6 35 
  4023d5:	c7 85 d8 fb ff ff 91 	movl   $0x3e84b591,-0x428(%rbp)
  4023dc:	b5 84 3e 
  4023df:	c7 85 dc fb ff ff 36 	movl   $0xa860b236,-0x424(%rbp)
  4023e6:	b2 60 a8 
    alignas(SSE_TYPE) C_OUT_TYPE out[OUT_LEN];

    SSE_TYPE v1;
    INSERT(&v1, in1);
  4023e9:	48 8d 95 b0 fb ff ff 	lea    -0x450(%rbp),%rdx
  4023f0:	48 8d 85 60 fb ff ff 	lea    -0x4a0(%rbp),%rax
  4023f7:	48 89 d6             	mov    %rdx,%rsi
  4023fa:	48 89 c7             	mov    %rax,%rdi
  4023fd:	e8 a2 f1 ff ff       	call   4015a4 <insert_i32>
    SSE_TYPE v2;
    INSERT(&v2, in2);
  402402:	48 8d 95 c0 fb ff ff 	lea    -0x440(%rbp),%rdx
  402409:	48 8d 85 70 fb ff ff 	lea    -0x490(%rbp),%rax
  402410:	48 89 d6             	mov    %rdx,%rsi
  402413:	48 89 c7             	mov    %rax,%rdi
  402416:	e8 89 f1 ff ff       	call   4015a4 <insert_i32>

    SSE_TYPE res = (SSE_TYPE)INTRINSIC_FUN((SSE_TYPE_IN)v1,(SSE_TYPE_IN) v2);
  40241b:	66 0f 6f 85 70 fb ff 	movdqa -0x490(%rbp),%xmm0
  402422:	ff 
  402423:	0f 28 c8             	movaps %xmm0,%xmm1
  402426:	66 0f 6f 85 60 fb ff 	movdqa -0x4a0(%rbp),%xmm0
  40242d:	ff 
  40242e:	0f 29 85 90 fb ff ff 	movaps %xmm0,-0x470(%rbp)
  402435:	0f 29 8d a0 fb ff ff 	movaps %xmm1,-0x460(%rbp)
  return (__m128) __builtin_ia32_movlhps ((__v4sf)__A, (__v4sf)__B);
  40243c:	0f 28 85 90 fb ff ff 	movaps -0x470(%rbp),%xmm0
  402443:	0f 16 85 a0 fb ff ff 	movhps -0x460(%rbp),%xmm0
  40244a:	90                   	nop
  40244b:	0f 29 85 80 fb ff ff 	movaps %xmm0,-0x480(%rbp)

    EXTRACT(out, res);
  402452:	66 0f 6f 85 80 fb ff 	movdqa -0x480(%rbp),%xmm0
  402459:	ff 
  40245a:	48 8d 85 e0 fb ff ff 	lea    -0x420(%rbp),%rax
  402461:	48 89 c7             	mov    %rax,%rdi
  402464:	e8 af f2 ff ff       	call   401718 <extract_i32>

    char in1_s[255];
    TO_STRING_IN(in1_s, in1);
  402469:	48 8d 95 b0 fb ff ff 	lea    -0x450(%rbp),%rdx
  402470:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  402477:	48 89 d6             	mov    %rdx,%rsi
  40247a:	48 89 c7             	mov    %rax,%rdi
  40247d:	e8 78 f7 ff ff       	call   401bfa <to_string_i32>
    char in2_s[255];
    TO_STRING_IN(in2_s, in2);
  402482:	48 8d 95 c0 fb ff ff 	lea    -0x440(%rbp),%rdx
  402489:	48 8d 85 f0 fc ff ff 	lea    -0x310(%rbp),%rax
  402490:	48 89 d6             	mov    %rdx,%rsi
  402493:	48 89 c7             	mov    %rax,%rdi
  402496:	e8 5f f7 ff ff       	call   401bfa <to_string_i32>
    char out_s[255];
    TO_STRING_OUT(out_s, out);
  40249b:	48 8d 95 e0 fb ff ff 	lea    -0x420(%rbp),%rdx
  4024a2:	48 8d 85 f0 fd ff ff 	lea    -0x210(%rbp),%rax
  4024a9:	48 89 d6             	mov    %rdx,%rsi
  4024ac:	48 89 c7             	mov    %rax,%rdi
  4024af:	e8 46 f7 ff ff       	call   401bfa <to_string_i32>
    char con_s[255];
    TO_STRING_OUT(con_s, con);
  4024b4:	48 8d 95 d0 fb ff ff 	lea    -0x430(%rbp),%rdx
  4024bb:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  4024c2:	48 89 d6             	mov    %rdx,%rsi
  4024c5:	48 89 c7             	mov    %rax,%rdi
  4024c8:	e8 2d f7 ff ff       	call   401bfa <to_string_i32>
  ...
  4024cd:	48 8d b5 f0 fe ff ff 	lea    -0x110(%rbp),%rsi
  4024d4:	48 8d 8d f0 fd ff ff 	lea    -0x210(%rbp),%rcx
  4024db:	48 8d 95 f0 fc ff ff 	lea    -0x310(%rbp),%rdx
  4024e2:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  4024e9:	48 8d 3d 38 4c 00 00 	lea    0x4c38(%rip),%rdi        # 407128 <_fini+0x164>
  4024f0:	49 89 f0             	mov    %rsi,%r8
  4024f3:	48 89 c6             	mov    %rax,%rsi
  4024f6:	b8 00 00 00 00       	mov    $0x0,%eax
  4024fb:	e8 20 04 00 00       	call   402920 <printf>
        }
    }
  ...
  402505:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  402509:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
  402510:	00 00 
  402512:	74 05                	je     402519 <main+0x1c6>
  402514:	e8 a7 03 00 00       	call   4028c0 <__stack_chk_fail>
  402519:	c9                   	leave
  40251a:	c3                   	ret
  40251b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000402520 <dummy>:
...
0000000000402530 <dummy1>:
  402530:	f3 0f 1e fa          	endbr64
  402534:	c3                   	ret
  402535:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40253c:	00 00 00 
  40253f:	90                   	nop
...
0000000000402540 <__init_libc>:
  ...
  4026cf:	48 8d 3d 84 4a 00 00 	lea    0x4a84(%rip),%rdi        # 40715a <_fini+0x196>
  ...
  402767:	48 8d 3d 2b 4a 00 00 	lea    0x4a2b(%rip),%rdi        # 407199 <_fini+0x1d5>
...
0000000000402ab0 <pop_arg>:
  ...
  402ab8:	48 8d 0d dd 46 00 00 	lea    0x46dd(%rip),%rcx        # 40719c <_fini+0x1d8>
...
0000000000402dc0 <fmt_fp>:
  ...
  402e30:	48 8d 05 2d 43 00 00 	lea    0x432d(%rip),%rax        # 407164 <_fini+0x1a0>
  ...
  402eca:	48 8d 05 96 42 00 00 	lea    0x4296(%rip),%rax        # 407167 <_fini+0x1a3>
  ...
  4032f6:	48 8d 1d 68 3e 00 00 	lea    0x3e68(%rip),%rbx        # 407165 <_fini+0x1a1>
  ...
  403330:	4c 8d 25 44 3e 00 00 	lea    0x3e44(%rip),%r12        # 40717b <_fini+0x1b7>
  403337:	48 8d 05 45 3e 00 00 	lea    0x3e45(%rip),%rax        # 407183 <_fini+0x1bf>
  ...
  4033c4:	4c 8d 25 b4 3d 00 00 	lea    0x3db4(%rip),%r12        # 40717f <_fini+0x1bb>
  4033cb:	48 8d 05 a5 3d 00 00 	lea    0x3da5(%rip),%rax        # 407177 <_fini+0x1b3>
  ...
  403ce0:	48 8d 3d a0 34 00 00 	lea    0x34a0(%rip),%rdi        # 407187 <_fini+0x1c3>
  ...
  40402b:	48 8d 3d 55 31 00 00 	lea    0x3155(%rip),%rdi        # 407187 <_fini+0x1c3>
  ...
  4046ee:	48 8d 3d 92 2a 00 00 	lea    0x2a92(%rip),%rdi        # 407187 <_fini+0x1c3>
...
0000000000404740 <printf_core>:
  ...
  404ed9:	48 8d 3d a9 22 00 00 	lea    0x22a9(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405094:	48 8d 3d ee 20 00 00 	lea    0x20ee(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405227:	48 8d 3d 5b 1f 00 00 	lea    0x1f5b(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405415:	48 8d 3d 6d 1d 00 00 	lea    0x1d6d(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405463:	48 8d 3d 1f 1d 00 00 	lea    0x1d1f(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405484:	48 8d 05 08 1d 00 00 	lea    0x1d08(%rip),%rax        # 407193 <_fini+0x1cf>
  ...
  405513:	48 8d 3d 6f 1c 00 00 	lea    0x1c6f(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  4055bb:	48 8d 3d c7 1b 00 00 	lea    0x1bc7(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  4056b3:	48 8d 3d cf 1a 00 00 	lea    0x1acf(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  405826:	48 8d 15 5c 19 00 00 	lea    0x195c(%rip),%rdx        # 407189 <_fini+0x1c5>
  ...
  4058cf:	48 8d 3d b3 18 00 00 	lea    0x18b3(%rip),%rdi        # 407189 <_fini+0x1c5>
  ...
  4058eb:	48 8d 3d 98 18 00 00 	lea    0x1898(%rip),%rdi        # 40718a <_fini+0x1c6>
  ...
  40590f:	48 8d 3d 75 18 00 00 	lea    0x1875(%rip),%rdi        # 40718b <_fini+0x1c7>
