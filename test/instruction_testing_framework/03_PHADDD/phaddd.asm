...
test_phaddd_static_musl:     Dateiformat elf64-x86-64
...
int main() {
  ...
  402371:	c7 85 b0 fa ff ff 0f 	movl   $0xf,-0x550(%rbp)
  402378:	00 00 00 
  40237b:	c7 85 b4 fa ff ff 0d 	movl   $0xd,-0x54c(%rbp)
  402382:	00 00 00 
  402385:	c7 85 b8 fa ff ff fd 	movl   $0xfffffffd,-0x548(%rbp)
  40238c:	ff ff ff 
  40238f:	c7 85 bc fa ff ff f9 	movl   $0xfffffff9,-0x544(%rbp)
  402396:	ff ff ff 
#ifdef SRC2
    C_IN_TYPE in2[IN_LEN] = SRC2;
  402399:	c7 85 c0 fa ff ff f6 	movl   $0xfffffff6,-0x540(%rbp)
  4023a0:	ff ff ff 
  4023a3:	c7 85 c4 fa ff ff 0f 	movl   $0xf,-0x53c(%rbp)
  4023aa:	00 00 00 
  4023ad:	c7 85 c8 fa ff ff 11 	movl   $0x11,-0x538(%rbp)
  4023b4:	00 00 00 
  4023b7:	c7 85 cc fa ff ff e9 	movl   $0xffffffe9,-0x534(%rbp)
  4023be:	ff ff ff 
#endif
    C_OUT_TYPE con[OUT_LEN] = CON;
  4023c1:	c7 85 d0 fa ff ff 1c 	movl   $0x1c,-0x530(%rbp)
  4023c8:	00 00 00 
  4023cb:	c7 85 d4 fa ff ff f6 	movl   $0xfffffff6,-0x52c(%rbp)
  4023d2:	ff ff ff 
  4023d5:	c7 85 d8 fa ff ff 05 	movl   $0x5,-0x528(%rbp)
  4023dc:	00 00 00 
  4023df:	c7 85 dc fa ff ff fa 	movl   $0xfffffffa,-0x524(%rbp)
  4023e6:	ff ff ff 
    ...
    SSE_TYPE v1;
    INSERT(&v1, in1);
  4023e9:	48 8d 95 b0 fa ff ff 	lea    -0x550(%rbp),%rdx
  4023f0:	48 8d 85 90 fa ff ff 	lea    -0x570(%rbp),%rax
  ...
  4023fd:	e8 a2 f1 ff ff       	call   4015a4 <insert_i32>
    ...
    SSE_TYPE v2;
    INSERT(&v2, in2);
  402402:	48 8d 95 c0 fa ff ff 	lea    -0x540(%rbp),%rdx
  402409:	48 8d 85 a0 fa ff ff 	lea    -0x560(%rbp),%rax
...
#else
    asm volatile (
  40241b:	66 0f 6f 8d a0 fa ff 	movdqa -0x560(%rbp),%xmm1
  402422:	ff 
  402423:	66 0f 6f 85 90 fa ff 	movdqa -0x570(%rbp),%xmm0
  40242a:	ff 
  40242b:	66 0f 38 02 c1       	phaddd %xmm1,%xmm0
  402430:	9c                   	pushf
  402431:	58                   	pop    %rax
  402432:	0f 29 85 90 fa ff ff 	movaps %xmm0,-0x570(%rbp)
  402439:	48 89 85 88 fa ff ff 	mov    %rax,-0x578(%rbp)
#endif
...
#else
    EXTRACT(out, v1);
  402440:	66 0f 6f 85 90 fa ff 	movdqa -0x570(%rbp),%xmm0
  402447:	ff 
  402448:	48 8d 85 e0 fa ff ff 	lea    -0x520(%rbp),%rax
  40244f:	48 89 c7             	mov    %rax,%rdi
  402452:	e8 c1 f2 ff ff       	call   401718 <extract_i32>
#endif

    char in1_s[255];
    TO_STRING_IN(in1_s, in1);
  402457:	48 8d 95 b0 fa ff ff 	lea    -0x550(%rbp),%rdx
  40245e:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  402465:	48 89 d6             	mov    %rdx,%rsi
  402468:	48 89 c7             	mov    %rax,%rdi
  40246b:	e8 8a f7 ff ff       	call   401bfa <to_string_i32>
#ifdef SRC2
    char in2_s[255];
    TO_STRING_IN(in2_s, in2);
  402470:	48 8d 95 c0 fa ff ff 	lea    -0x540(%rbp),%rdx
  402477:	48 8d 85 f0 fb ff ff 	lea    -0x410(%rbp),%rax
  40247e:	48 89 d6             	mov    %rdx,%rsi
  402481:	48 89 c7             	mov    %rax,%rdi
  402484:	e8 71 f7 ff ff       	call   401bfa <to_string_i32>
#endif
    char out_s[255];
    TO_STRING_OUT(out_s, out);
  402489:	48 8d 95 e0 fa ff ff 	lea    -0x520(%rbp),%rdx
  402490:	48 8d 85 f0 fc ff ff 	lea    -0x310(%rbp),%rax
  402497:	48 89 d6             	mov    %rdx,%rsi
  40249a:	48 89 c7             	mov    %rax,%rdi
  40249d:	e8 58 f7 ff ff       	call   401bfa <to_string_i32>
    char con_s[255];
    TO_STRING_OUT(con_s, con);
  4024a2:	48 8d 95 d0 fa ff ff 	lea    -0x530(%rbp),%rdx
  4024a9:	48 8d 85 f0 fd ff ff 	lea    -0x210(%rbp),%rax
  4024b0:	48 89 d6             	mov    %rdx,%rsi
  4024b3:	48 89 c7             	mov    %rax,%rdi
  4024b6:	e8 3f f7 ff ff       	call   401bfa <to_string_i32>
#ifdef IMM8
    char imm8_s[255];
  ...
  4024bb:	48 8b 95 88 fa ff ff 	mov    -0x578(%rbp),%rdx
  4024c2:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
  4024c9:	48 89 d6             	mov    %rdx,%rsi
  4024cc:	48 89 c7             	mov    %rax,%rdi
  4024cf:	e8 a0 fc ff ff       	call   402174 <flags_to_string>
#ifdef PRINT
#ifdef IMM8
...
#elifdef SRC2
    printf(STR(INST_NAME)"\nsrc1: %s\nsrc2: %s\n |\n\\/\nres: %s\ncon: %s\nflags: %s\n",
  4024d4:	4c 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%r8
  4024db:	48 8d b5 f0 fd ff ff 	lea    -0x210(%rbp),%rsi
  4024e2:	48 8d 8d f0 fc ff ff 	lea    -0x310(%rbp),%rcx
  4024e9:	48 8d 95 f0 fb ff ff 	lea    -0x410(%rbp),%rdx
  4024f0:	48 8d 85 f0 fa ff ff 	lea    -0x510(%rbp),%rax
  4024f7:	48 8d 3d 2a 4c 00 00 	lea    0x4c2a(%rip),%rdi        # 407128 <_fini+0x164>
  4024fe:	4d 89 c1             	mov    %r8,%r9
  402501:	49 89 f0             	mov    %rsi,%r8
  402504:	48 89 c6             	mov    %rax,%rsi
  402507:	b8 00 00 00 00       	mov    $0x0,%eax
  40250c:	e8 2f 04 00 00       	call   402940 <printf>
        }
    }
  ...
  402516:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  40251a:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
  402521:	00 00 
  402523:	74 05                	je     40252a <main+0x1d7>
  402525:	e8 b6 03 00 00       	call   4028e0 <__stack_chk_fail>
  40252a:	c9                   	leave
  40252b:	c3                   	ret
  40252c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000402530 <dummy>:
...
0000000000402560 <__init_libc>:
  ...
  4026ef:	48 8d 3d 6c 4a 00 00 	lea    0x4a6c(%rip),%rdi        # 407162 <_fini+0x19e>
  ...
  402787:	48 8d 3d 13 4a 00 00 	lea    0x4a13(%rip),%rdi        # 4071a1 <_fini+0x1dd>
...
0000000000402ad0 <pop_arg>:
  ...
  402ad8:	48 8d 0d c5 46 00 00 	lea    0x46c5(%rip),%rcx        # 4071a4 <_fini+0x1e0>
...
0000000000402dc0 <fmt_fp>:
  ...
  402e30:	48 8d 05 35 43 00 00 	lea    0x4335(%rip),%rax        # 40716c <_fini+0x1a8>
  ...
  402eca:	48 8d 05 9e 42 00 00 	lea    0x429e(%rip),%rax        # 40716f <_fini+0x1ab>
  ...
  4032f6:	48 8d 1d 70 3e 00 00 	lea    0x3e70(%rip),%rbx        # 40716d <_fini+0x1a9>
  ...
  403330:	4c 8d 25 4c 3e 00 00 	lea    0x3e4c(%rip),%r12        # 407183 <_fini+0x1bf>
  403337:	48 8d 05 4d 3e 00 00 	lea    0x3e4d(%rip),%rax        # 40718b <_fini+0x1c7>
  ...
  4033c4:	4c 8d 25 bc 3d 00 00 	lea    0x3dbc(%rip),%r12        # 407187 <_fini+0x1c3>
  4033cb:	48 8d 05 ad 3d 00 00 	lea    0x3dad(%rip),%rax        # 40717f <_fini+0x1bb>
  ...
  403ce0:	48 8d 3d a8 34 00 00 	lea    0x34a8(%rip),%rdi        # 40718f <_fini+0x1cb>
  ...
  40402b:	48 8d 3d 5d 31 00 00 	lea    0x315d(%rip),%rdi        # 40718f <_fini+0x1cb>
  ...
  4046ee:	48 8d 3d 9a 2a 00 00 	lea    0x2a9a(%rip),%rdi        # 40718f <_fini+0x1cb>
...
0000000000404740 <printf_core>:
  ...
  404ed9:	48 8d 3d b1 22 00 00 	lea    0x22b1(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405094:	48 8d 3d f6 20 00 00 	lea    0x20f6(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405227:	48 8d 3d 63 1f 00 00 	lea    0x1f63(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405415:	48 8d 3d 75 1d 00 00 	lea    0x1d75(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405463:	48 8d 3d 27 1d 00 00 	lea    0x1d27(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405484:	48 8d 05 10 1d 00 00 	lea    0x1d10(%rip),%rax        # 40719b <_fini+0x1d7>
  ...
  405513:	48 8d 3d 77 1c 00 00 	lea    0x1c77(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  4055bb:	48 8d 3d cf 1b 00 00 	lea    0x1bcf(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  4056b3:	48 8d 3d d7 1a 00 00 	lea    0x1ad7(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  405826:	48 8d 15 64 19 00 00 	lea    0x1964(%rip),%rdx        # 407191 <_fini+0x1cd>
  ...
  4058cf:	48 8d 3d bb 18 00 00 	lea    0x18bb(%rip),%rdi        # 407191 <_fini+0x1cd>
  ...
  4058eb:	48 8d 3d a0 18 00 00 	lea    0x18a0(%rip),%rdi        # 407192 <_fini+0x1ce>
  ...
  40590f:	48 8d 3d 7d 18 00 00 	lea    0x187d(%rip),%rdi        # 407193 <_fini+0x1cf>
